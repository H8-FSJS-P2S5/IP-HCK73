        ...
        <section className="bg-white font-outfit">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div className="mx-auto max-w-screen-sm text-center">
                    ...
                    <Link to={'/'}
                        className="inline-flex text-white bg-blue-600 hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center my-4"
                    >
                        Back to Homepage
                    </Link>
                </div>
