...
{/* left_side */}
      ...
      <div className='flex-col'>
        ...
        <div className='h-lvh w-full flex flex-col' style={{backgroundColor : "#F5F5DC"}}>
        <div className='h-3/4' style={{backgroundColor : "#36454F"}}> 
        <div className='flex justify-center mt-36'>
        <h1 className='text-6xl  '>Descover New Recipes</h1>

        </div>
{/* button  */}
        <div className='flex w-full justify-center gap-5 mt-28'>
            <button className='w-32 h-10 bg-red-600 rounded-full'>Add Recipe</button>
            <button className='w-32 h-10 bg-red-600 rounded-full'>See more</button>
        </div>

        </div>
        <div className='h-1/4 flex' style={{backgroundColor : "#8B4513"}}>
        
            <div className='bg-pink-300 w-1/2 h-full flex justify-center items-center'>
                <h2>Rcipes around the glob</h2>
            </div>
            <div className='bg-pink-300 w-1/2 h-full flex justify-center items-center'>
