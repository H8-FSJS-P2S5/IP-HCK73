        ...
        <div className="mx-auto w-1/3 bg-[#151515] border border-black rounded-xl shadow-lg">
          <div className="p-4 sm:p-7">
            ...
            <div className="mt-5">
              ...
              {/* <div className="mt-8 mb-4 py-3 flex items-center text-sm text-gray-400 before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6 ">
                Or sign in with
              </div> */}
